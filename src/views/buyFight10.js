export const html = `
  <!-- Buy $FIGHT10 — shown when a wallet can't cover the 10,000 PvP entry fee -->
  <div class="overlay" id="buyFight10Overlay">
    <div class="panel">
      ...
      <div class="tab-body buyf10-body">
        ...
        <div class="buyf10-title">You need <span class="buyf10-amount">10,000 $FIGHT10</span> to enter a PvP match.</div>
        <div class="buyf10-balance" id="buyFight10Balance"></div>
        <a class="buyf10-btn" id="buyFight10Link" href="https://solscan.io" target="_blank" rel="noopener noreferrer">BUY $FIGHT10</a>
