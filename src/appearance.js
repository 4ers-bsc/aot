...
// black/gold armored knight, skin "3" the crowned king in a gold pixel-mosaic
// suit. Each skin's palette is fixed; the hex ints feed straight into
// game.setPlayerAppearance() → the fighter's material map. The king uses the
// same five slots: skin = the gold head core behind the white face, gi =
// jacket, pants = trousers, trim = crown, hair = gloves.
export const APPEARANCE_PRESETS = {
  ...
  3: { skin: 0xf2d41e, hair: 0xd4d4d8, gi: 0xecc81a, trim: 0xd8a938, pants: 0xdcb214 }
};
