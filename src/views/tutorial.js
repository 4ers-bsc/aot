    ...
    <div class="panel tutorial-panel">
      ...
      <div class="tut-body">
        ...
        <div class="tut-step is-active" data-tut-step="0">
          ...
          <div class="tut-step-text">FIGHT10 is a skill-based arena on Solana. Stake $FIGHT10, drop into a free-for-all, and be the last fighter alive to take <span class="hs-gold">90% of the pot</span>.</div>
        </div>
        ...
        <div class="tut-step" data-tut-step="1">
          ...
          <div class="tut-step-text">Link your Solana wallet — Phantom, Backpack, or Brave — and stake <span class="hs-gold">2,500 $FIGHT10</span> to claim your seat. Your entry is verified on-chain before the match begins.</div>
        </div>
