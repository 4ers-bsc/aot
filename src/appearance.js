...
// black/gold armored knight, skin "3" the Degent — the crowned ape in a black
// suit with a whiskey bottle, built from the Degent model (see buildDegentBody
// in game.js). Each skin's palette is fixed; the hex ints feed straight into
...
export const APPEARANCE_PRESETS = {
  ...
  // Degent: skin = ape face + hands, hair = fur + shoes, gi = jacket, trim =
  // the gold (crown, face lines, shirt, pocket square, cuffs), pants = trousers + lapels.
  3: { skin: 0x3a2c25, hair: 0x0b0b0d, gi: 0x17181c, trim: 0xd9a821, pants: 0x101114 }
};
